...
|---|---|
| "Keep building (Recommended)" | Call Skill tool → skill: "build" |
| "Deep review" | Call Skill tool → skill: "deep-review" |
| "Quick review" | Call Skill tool → skill: "quick-review" |
...
WRONG: outputting `/build` or any slash command as text (does nothing)
...
| User selects | YOUR ACTION (tool call, not text) |
|---|---|
| "Deep review (Recommended)" | Call Skill tool → skill: "deep-review" |
| "Quick review" | Call Skill tool → skill: "quick-review" |
...
WRONG: outputting `/deep-review` or any slash command as text (does nothing)
WRONG: any words before or instead of the tool call
CORRECT: a single Skill tool call as the entire response
