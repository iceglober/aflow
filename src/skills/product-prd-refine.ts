export function productPrdRefine(): string {
  return `---
...
3. What STILL requires user decisions ([DATA NEEDED] and blockers — unchanged)
4. Any new open questions the research revealed
...
After applying changes, provide a change summary:
