export function productPipeline(): string {
  return `---
...
Present Gate 2 results:
  - Requirements count, blocker count, [DATA NEEDED] count
  - What was researched and strengthened
  - What STILL needs user decisions (blockers + [DATA NEEDED])
  - Ask for feedback, corrections, priority ranking
